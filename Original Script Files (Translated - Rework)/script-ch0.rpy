label ch0_main:
    ...
    hide monika
    show sayori zorder 3 at f31
    s 4x "快坐下吧，[player]！这边给你留了座位，你可以坐在我或者莫妮卡的边上。"
    s "我去拿蛋糕咯~"
    show sayori zorder 2 at t31
    ...
    "与此同时，夏树和优里走到了房间的角落，夏树端出来一个盖好的托盘，而优里则打开了储藏间。"
    ...
    show natsuki at s32
    n 5s "...又不是为了你才做的。"
    mc "诶？我觉得其实就是吧。我听纱世里说——"
    show natsuki zorder 2 at t32
    n 12c "那，也许是吧！"
    n "但，反正不是为了...就、总之就是...不是为 {i}你{/i} 而做的！笨蛋......"
    mc "好吧，好吧..."
    show natsuki zorder 1 at thide
    hide natsuki
    "我放弃理解夏树的古怪逻辑，只能草草结束了对话。"
    "优里端着一套茶具，回到了桌旁。"
    "她小心翼翼地在每个人面前摆好一个茶杯，然后将茶壶放置在蛋糕托盘旁边。"
    ...
    m 1j "没问题！不用不好意思！"
    m 1b "我们会给你家一般的感觉，好吗？"
    m "作为文学部的部长，我的职责就是让社团充满乐趣和活力，让大家度过一段更有趣的社团时光！"
    show monika 1a
    mc "莫妮卡，我其实有些惊讶。"
    mc "你是怎么想到自己成立一个社团的？"
    ...
    m 1b "而且，要是这样能鼓励他人接触文学，那么我就是在实现这个梦想了！"
    show monika 1a
    ...
    m "尤其是像文学这种吸不到多少注意力的东西。"
    m "你必须加倍努力才能向大家证明，你们这个社团既有趣又有意义。"
    m "但这也让学园祭之类的校园活动，变得更加重要。"
    ...
    y "超现实恐怖小说通常会成功改变你看待世界的方式，哪怕只有一小会儿。"
    show yuri zorder 2 at t32
    ...
    y 2k "最真挚的文字是写给自己的。"
    y "所以分享的前提是，你必须愿意向读者敞开心扉、暴露出自己的脆弱，甚至展现内心最深处。"
    show natsuki zorder 1 at thide
    hide natsuki
    ...
    show monika zorder 3 at f43
    m 1d "诶？什么问题啊？"
    "既然话题又回到了拉我进社团这件事上，我终于能直截了当地说出我一直以来的心声了。"
    show monika zorder 2 at t43
    mc "我从来都没说过我要加入文学部啊！"
    mc "虽然纱世里说服了我过来看看，但我可没下过任何决定。"
    mc "我还有别的一些社团要看下，而且......呃......"
    show monika 1g
    show sayori 1g
    show natsuki 4g
    show yuri 2e
