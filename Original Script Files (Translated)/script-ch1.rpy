...
label ch1_main:
    ...
    n "诶，拜托！说得好像应该放他一马似的。"
    n "纱世里跟我说过，你今年本来一个社团都不想加入的。"
    n "而且去年也是！"
    n 4c "虽然我不知道你是打算过来随便混混，还是想怎样......"
    ...
    s "各位别担心嘛~"
    s "只要 [player] 乐在其中，他一定会尽力的哦。"
    s "即使我什么都没说，他也会主动帮我做一些琐事。"
    s "比如说帮我做饭、打扫房间......"
    show sayori 2a zorder 2 at t21
    show yuri zorder 3 at f22
    y 2m "真可靠啊......"
    show yuri zorder 2 at t22
    mc "拜托，纱世里，那是因为你的房间实在乱得让人分心。"
    mc "更别说有次你差点把整个房间都点着了。"
    show sayori at s21
    s 5 "是这样吗......欸嘿嘿..."
    show yuri zorder 3 at f22
    y 1s "你们俩还真是关系很好的朋友呢，对吧？"
    y "我可能会有点嫉妒哦......"
    show yuri zorder 2 at t22
    show sayori zorder 3 at f21
    s 1 "怎么会呢？你跟 [player] 也可以成为好朋友啊！"
    ...
    show sayori zorder 2 at t21
    mc "......"
    "和往常一样，纱世里似乎完全没意识到，她刚刚害我陷入了何等尴尬的境地。"
    show sayori zorder 3 at f21
    s 4x "哦，对了！你知道优里今天甚至还给你带了件东西吗~"
    show sayori zorder 2 at t21
    show yuri zorder 3 at f22
    y 3n "等、等一下，纱世里.....！"
    show yuri zorder 2 at t22
    ...
    mc "嘿，不用太介意的。"
    mc "首先，我从一开始就没有期待过什么。"
    mc "也就是说，你的任何善意之举都会让我非常惊喜。"
    mc "不管是什么，我都会很高兴的。"
    y 3v "是、是这样吗......"
    mc "嗯，对。你要是不愿意，我也不强求的。"
    y "好吧......"
    y 1a "呐，给你。"
    "优里把手伸进包里，掏出了一本书。"
    y "我希望你可以更快地融入进来......"
    ...
    mc "那、那当然......"
    "我的轻松时光戛然而止。"
    "真不敢相信自己居然答应了做这种羞耻到爆炸的事情。"
    "老实说，我找不到什么灵感，毕竟我从来都没写过诗。"
    m "好，既然大家都准备好了，那就找个人分享一下吧？"
    ...
    hide monika
    "纱世里和莫妮卡迫不及待地拿出了她们的诗。"
    "纱世里的诗写在一张皱巴巴的、从线圈笔记本上撕下来的活页纸上。"
    "另一边，莫妮卡则把诗写在了作文本上。"
    "我在自己座位上都能看到莫妮卡那干净的字迹。"
...
label ch1_end:
    ...
    n 4w "才不是呢！"
    n "是她先挑起来的！"
    n 4e "如果她能别那么自以为是，学着去品味，{i}简洁的{/i}写作才更行之有效......"
    n "那么这件事压根就不会发生！"
    n "无缘无故把诗写得那么晦涩有什么意义吗？"
    n "诗的内涵就应该让读者直接领略，而不是强迫读者去绞尽脑汁冥思苦想。"
    n 1f "所以 [player]，你倒是帮我把这点解释给她听啊！"
    show natsuki zorder 2 at t22
    show yuri zorder 3 at f21
    y 3o "等、等一下！"
    y "我们的语言中有那么多深奥而又富有表现力的辞藻，那都是有原因的！"
    y 3w "只有通过这些辞藻，我们才能最为有效地传达复杂情感和内涵。"
    y "对它们避之犹恐不及，不仅毫无必要地限制了自己的发挥......而且还是种浪费！"
    y 1t "[player]，你也懂的吧？"
    show yuri zorder 2 at t21
    mc "唔......！"
    ...
    m 1a "既然如此，我们明天也这么做吧。"
    m "也许你们也从朋友身上有所收获。"
    m 3b "这样的话你们的诗作就会更加优秀了！"
    mc "......"
    show monika zorder 1 at thide
    hide monika
    "我暗自忖度。"
    "我确实收获多了一点每个人对诗歌的喜好。"
    "这就意味着，运气好的话，我至少可以更好地打动那些我想要打动的人。"
    "带着新的决心，我暗自点了点头。"
    ...
    s 1g "你......你应该不会讨厌她们吧？"
    mc "嗯，我当然不讨厌她们！"
    mc "我只是想要听听你的看法，没别的意思。"
    mc "我能理解为什么她们会和你成为好朋友了。"
    show sayori zorder 2 at t11
    s 1d "呼......"
    s "那个，[player]......"
    s "虽然我很开心能在社团里和你共度时光。"
    s "但是我觉得，看着你和大家相处得那么融洽，才是最让我高兴的事。"
    s 1x "而且我觉得大家也都很喜欢你！"
    mc "这——！"
    s 4q "诶嘿嘿~"
    s "之后每天都会充满乐趣的~"
    ...
    mc "纱世里，以后的事以后再说吧。"
    "我拍了拍纱世里的肩膀。"
    "这句话其实我更多地是说给自己，而不是说给她听，只不过有时很容易把纱世里当作内心独白的对象。"
    show sayori at h11
    s 1x "好吧~！"
    "嗯......"
    "那就加油吧！"
...
label ch1_end_natsuki:
    ...
    hide natsuki
    m "好了，既然这事已经过去了......"
    m 4b "大家都已经读过对方的诗了，对吧？"
    m "希望大家都能不虚此行！"
    m 5 "尤其是你，[player]！"
    m "而且老实说......"
    m "以前我们过于习惯懒懒散散，像这样改变一下节奏倒也不错。"
    m "啊哈哈哈！"
    mc "啊，所以说我加入社团也算是破坏了气氛吧......"
    m 1d "不不不，完全不是，完全不是！"
    m "在回家前，我们还有些时间。"
    m 1a "那我们就都休息会儿吧。"
    m "当然，除了聊天之外，我们也会在部室做一些与文学相关的事情......"
    m "所以你们或许可以趁着这次机会找本书看，或者写些东西。"
    m 1b "毕竟，这才是我们文学部的目的！"
    ...
    with wipeleft
    "不过，莫妮卡总归说得没错。"
    "加入文学部大概也就意味着，我不能把所有时间都用来闲着、无所事事了。"
    "但归根结底......"
    "......到目前为止，我觉得加入还是值得的。"
    return
...
label ch1_end_yuri:
    ...
    show natsuki zorder 1 at thide
    hide natsuki
    "夏树冷不丁地从桌上一把抓起自己的诗，冲出了教室。"
    "在出去的路上，她把诗揉成一团，扔进了垃圾桶。"
    show sayori zorder 3 at f41
    s 1k "夏树......"
    show sayori zorder 2 at t41
    show monika zorder 3 at f32
...
label ch1_end_sayori:
    ...
    mc "夏、夏树......"
    show natsuki 5f
    "夏树朝我杏眼圆瞪，我本来话已到嘴边，却又都咽了回去。"
    "于是，我转向了优里。"
    mc "优里......"
    y 4a "......"
    "但优里的表情实在太无助了，我也没法对她开口说些什么。"
    stop music fadeout 1.0
    mc "......"
    mc "......纱世里！"
    ...
    s "诶？！"
    mc "......没错！"
    mc "大家这样争来争去的，整得纱世里可不舒服了。"
    mc "你们俩明知这样会让朋友产生困扰，怎么还能继续吵个不停呢？"
    show sayori zorder 3 at f31
    s 4d "[player]......"
    show sayori zorder 2 at t31
    show natsuki 4w zorder 3 at f33
    n "呃......那是她自己个人的问题！这件事明明跟她无关。"
    show natsuki zorder 2 at t33
    show yuri 2g zorder 3 at f32
    y "我、我同意......"
    y "别人硬要介入我们的争执，还拿自己的感情来说事，这可不公平。"
    show yuri zorder 2 at t32
    show natsuki zorder 3 at f33
    n 4c "对啊，除非纱世里想说优里是一个自命不凡的蠢货。"
    show natsuki zorder 2 at t33
    ...
    s 1h "夏树！优里！"
    s "你们都是我的朋友！"
    s 1v "我-我只是希望大家都能愉快相处！"
    s "我的朋友都是很棒的人......"
    s "而我爱大家，是因为大家都与众不同！"
    s 1g "夏树的诗......"
    s "写得都很精彩，因为寥寥数语就能唤起读者心中各种各样的情感！"
    s "优里的诗也很精彩，因为能在你脑海中描绘出美好的画面！"
    s 4k "明明大家都很有才华......"
    s "......那为什么我们还非要争个高下不可呢......？"
    show sayori zorder 2 at t31
    show natsuki zorder 3 at f33
    ...
    mc "我当时一样说不出什么话来。"
    m "这个嘛......"
    m 2a "这或许说明，纱世里有自己的独到之处，不是吗？"
    mc "可以这么说。"
    mc "她可能有些傻乎乎的，但是有时候又让人不得不怀疑，她其实可清楚自己在做什么了。"
    m 5 "我明白了~"
    m "好好照顾她，好吗？"
    m "我可不愿看到她受伤。"
    mc "我也是这么想的......"
    mc "包在我身上。"
    "莫妮卡甜甜地对我微笑，我的心也为之紧了一下。"
    "不管她说了什么，这么一个真诚的人确实会是个好部长。"
    "但愿有机会能跟她再多聊一会儿......"
    return
