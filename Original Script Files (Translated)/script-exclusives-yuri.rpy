label yuri_exclusive_1:
    ...
    "糟了——"
    "她似乎注意到我正在看她......"
    "她又偷偷看了我一眼，有那么一瞬间，我们四目相对。"
    y 4b "......"
    "可她却把头埋进书里，埋得更深了。"
    mc "抱歉......"
    mc "我只是在发呆......"
    "我喃喃地说着，察觉到自己似乎让她有些不自在。"
    y 1i "哦......"
    y "没事的......"
    ...
    mc "我一定会尽快开始读的！"
    y 2u "那挺好的......"
    y "一旦开始读了，想再把书放下就比较难了。"
    y 2c "这是个非常让人身临其境、引人入胜的故事。"
    mc "这样吗......？"
    mc "话说，这本书是讲什么的呢？"
    y 1f "这个嘛......"
    y "唔唔......"
    ...
    "封面上印着一个不祥的眼睛符号。"
    y 1a "好吧......"
    y "我只是想确保等一下不会一不小心剧透点什么。"
    y "总的来说，这本书是讲的是一个高中女生搬到她失散多年的妹妹家一起住......"
    y "但是她一搬进去，她的生活就开始变得非常诡异。"
    y 1m "她开始被一些从人体试验监狱里逃出来的人追杀......"
    y "在遭遇生命危险时，她急需选择到底要信任谁。"
    y 1i "但是无论怎么选择，她最终都会毁掉自己的大部分人际关系，人生也开始分崩离析......"
    mc "这情节可有点——！"
    "有点黑暗，是吧？"
    "优里的语气让人觉得这会是个愉快的故事，因此这暗黑的转折就显得突如其来了。"
    y 1c "啊哈哈。"
    "优里突然轻笑起来。"
    y "你是不是不太喜欢这种故事啊，[player]？"
    mc "不，倒也不是这样......"
    mc "我是说，这种小说我也是能够欣赏的啦，不要担心。"
    y 2u "但愿如此......"
    "是啊......我完全忘了优里很喜欢这类黑暗深邃的东西。"
    "她看起来害羞又孤僻，但思维却好像完全不同。"
    y "只不过，那一类故事......"
    y 1a "总是能挑战你以一种新奇的角度去看待生活。"
    y "恐怖事件的起因，有时候并不仅仅是有人想要作恶......"
    y 1m "而是因为每个人都有他们自己的目的，或是他们深信不疑的思想体系。"
    y "而当你以为自己能和主角感同身受时，突然之间，你会意识到......"
    y "他们总是以自己那片面的道德观念来干涉反派的计划，他们才是那个不成熟的人。"
    y 3v "我......我是不是说得有点乱......？"
    y "又变成这样了......"
    y 4b "对不起......"
    mc "嘿，不用道歉的......！"
