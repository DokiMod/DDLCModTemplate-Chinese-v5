...
label poemresponse_start:
    ...
    # This function resets the read poem status for all characters.
...
label ch1_y_end:
    ...
    mc "你对幽灵很感兴趣吗，优里？"
    y 1m "呼呼。"
    y "实际上，这个故事跟幽灵完全没关系哦，[player]。"
    mc "真的假的？"
    mc "那我肯定完全理解错了......"
    y 1u "嗯，毕竟你只是草草浏览了一下......"
    y "不过你要记住，诗人常常会在自己的作品中表达他们的思想、情感以及经历。"
    y 1a "他们通常并不会只讲一个简单的故事，或是单纯把画面描绘出来。"
    y "而在这首诗里，诗的主体只是象征意义上的幽灵，"
    y 2l "徘徊在她最后一处安身立命之所，无法对往昔释怀，"
    y "而且很快就会一无所有......"
    mc "......这么一解释，这首诗就变得庄严肃穆了很多。"
    mc "我想都没有想到过那些方面......"
    mc "真是写得太好了。"
    if poemopinion == "good":
        y 2f "诶？"
        ...
        y "这些事情都会让我非常紧张。"
        y "不过到头来，我自己也很享受。"
        y "[player]，为了你，我会继续做到最好的！"
        mc "啊......"
        mc "我也会的。"
    else:
        y 1u "其实真的没什么......"
        y "不过......你能这么想，我很开心。"
        y 1a "不过你要记住，过不了多久，你也会领略这些东西的。"
        mc "嗯，或许你说得没错。"
        mc "看来我必须要继续努力了。"
        y "我相信你。"
    return
...
label ch2_y_end:
    ...
    y 2m "唔......"
    y "比起昨天那首，我写这首诗时更大胆了一些......"
    mc "看得出来。"
    mc "这首诗的隐喻意义要深得多......"
    "不知道是不是我自身的问题，我开始捉摸不透这首诗的主题。"
    y 1a "是的。"
    y "这更接近于我偏爱的写作风格......"
    y "以诗为画布来表达生动的意象，并借此来传达情感。"
    mc "嗯，光从字面上来理解的话，我甚至都不清楚这首诗究竟是个什么意思......"
    y 2f "这个嘛......"
    y "我觉得每个人都可以用自己的方式理解。"
    y "我想表达的是，我在沉溺于不寻常爱好时的心路历程......"
    y 2v "平常我会强行将这些东西深藏在心底。"
    y "因此，我有时候会很享受用笔将这些感受写下来。"
    ...
    if n_readpoem and (get_character_poem_appeal("natsuki", 1) >= 0 or get_character_poem_appeal("natsuki", 2) >= 0):
        ...
        y 2e "......？"
        mc "夏树不也写过类似的东西吗？"
        mc "说有些人会因为有着奇怪的兴趣而遭人揶揄奚落。"
        y 2h "诶？"
        y "她......她也写过？"
        mc "是啊......"
        mc "她写的是，只要不伤害到任何人，那么沉溺于什么样的爱好都没关系。"
        y 3r "她——她说得没错！"
        y 3o "啊——我是说......"
        y "她真的这么觉得吗......？"
        mc "是的。"
        mc "看起来你们在这一点上还是一样的......"
        y 3h "那......那还，挺有趣的......"
        y "在我看来，她就像是那种会取笑我爱好的人......"
        y "不过我觉得我也不该妄加评判，对吧......？"
        y 3p "啊——请不要告诉她我说过刚刚那些话！"
        mc "啊哈哈。别担心，我不会那样做的。"
        y 1l "好吧......"
        y 1a "嗯，谢谢你和我分享。"
    else:
        mc "为什么你要藏起自己的爱好秘而不宣呢？"
        y 3v "因......因为......"
        y "很尴尬啊......"
        y "而且大家会取笑我的。"
        y "[player]，你没有类似的爱好吗？"
        ...
        mc "嗯，我想我也有吧......"
        y 2h "我感觉每个人都有那样的小秘密。"
        y "我们能做的就是，尊重彼此以及我们自己的个体嗜好。"
        y "虽然有的时候会比较难，有些事物也会让我们感到不适......"
    y 1a "但毕竟，要是我还没学会如何接纳自己的怪异之处，那么我也许就会讨厌自己了。"
    y 2u "我、我好像有点胡言乱语了......"
    y "......但你能耐心倾听真的是太好了。"
    ...
    if get_appeal("yuri") >= 2:
        y 2s "你真的擅长很多东西......"
        y "写作，倾听......"
        y 2u "[player]，像你这样的人已经不多了......"
        mc "这、这有点夸张了吧......"
        y 2v "但我就是......这么觉得的。"
        y "我从来没有想过，我能毫不介怀地和人分享自己的文字......"
        y 2s "而现在，我简直就是翘首以待了......"
        y 2m "这对我来说......感觉真的棒极了。"
        y "而这一切都多亏了你。"
        mc "没......没什么的，真的......"
...
label ch3_y_end:
    ...
    if not n_read3 or get_appeal("natsuki") >= 3:
        ...
        y "她没说什么奇怪的东西吧？"
        y "她只是想要我们再来一次同题写作......"
    y 2f "我想这样应该能更好地比较我们在写作风格......或者说思维过程上的差异吧。"
    y 2w "不管怎么说，这是她的主意......！"
    y "你知道她的，她想这么做也并不奇怪。"
    y "她可能只是想要卖弄一下。"
    y 2v "我也不是对她的写作风格有什么特别的兴趣......"
    y "只是顺着她的要求做了。"
    y "不过......"
...
label ch3_y_end_special:
    ...
    if n_read3:
        "而且，这显然不是夏树提到的那首诗......"
        "......也就是说，我可能是唯一一个读到她这首诗的人。"
    y 2v "我、我不知道自己能不能解释清楚......"
    mc "没关系的。"
    mc "这首诗我能读懂。"
    y 4c "......"
    "优里现在甚至比平时还要更难开口。"
    ...
    mc "希望我们还能一起共度时光。"
    show yuri 4e
    "尽管我没有进行眼神交流的勇气，但我还是看到了优里唇边泛起的淡淡微笑。"
    "我又一次试着把诗还给她。"
    show yuri 4a
    "但是优里却轻轻地握着我的手推了回来。"
...
label ch2_s_end:
    ...
    s 1b "吓人......？"
    mc "呃，倒也不完全算是......"
    mc "大概是因为我太习惯于你开开心心的样子了吧......"
    mc "......算了，别在意。"
    mc "我有点想得太多了。"
    mc "关键在于，你的诗效果还挺不错的，所以你应该为此感到自豪。"
    s 1y "嗷，谢谢~"
    s "我觉得......"
    s "我觉得我就应该用这种方式来表达自己。"
    s "这甚至让我对自己的情感有了更好的理解......"
    s 1a "写作简直就跟魔法一样！"
    mc "你好像对写作产生了强烈的热情啊？"
    mc "希望你能够继续保持。"
    s 4r "嗯！"
    ...
    s "我要一直写到我死的时候！"
    mc "啊哈哈......别想太远了。"
    "纱世里一直是三分钟热度，她热衷某些东西通常不超过一个星期就会放弃。"
    "不知道写作会不会也一样呢？"
    "不过从她眼中迸发的热情来看，我似乎也没什么理由悲观。"
    return
...
label ch2_m_end:
    ...
    m "总之......"
    m 3b "以下是莫妮卡的今日写作小窍门！"
    m "有时候你会发现自己正面临着一个非常艰难的抉择......"
    m "这样情况下，别忘了给游戏存档哦！"
    m "你永远也不会知道自己什么时候会改变主意......"
    m "......又或者什么时候会发生意外的事情！"
    m 3d "等等......这个小窍门跟写作有关系吗？"
    m 3k "我到底在说些什么啊？"
    m "啊哈哈！"
    m 3b "......以上就是我今天的建议！"
    m "感谢倾听~"
...
label ch1_n_good:
    ...
    n 4c "算、算了。我不想发表意见。"
    mc "诶？那分享又有什么意义呢？"
    mc "我本可以用写诗的时间做其它事情的啊。"
    n 4r "唔......"
    mc "实际上，你还记得我说过，我想读你的诗吗？"
    mc "我在写这首诗时，脑海中就是想着那句话。"
    mc "我想帮助你安心分享自己的诗。"
    mc "就像莫妮卡所说的那样。"
    n 4x "呜......！"
    n 1h "要是你的诗超级无敌烂的话，我就能更加安心分享我的诗！"
    n 1w "你应该给我看一首非常蠢的诗，然后我就可以说‘哈，这可不够好啊，那么让我给你看看真正的文学是怎么样的吧！’"
    n 1h "但是你却让我的期待落空了！"
    n "你现在满意了？"
    mc "......"
    mc "......所以，换句话说，你是在说你喜欢我这首诗？"
    n 1o "呃——"
...
label ch3_n_bad:
    if get_character_poem_appeal("natsuki", 1) < 0 and get_character_poem_appeal("natsuki", 2) < 0:
        ...
        n "这简直是大退步。"
        mc "诶？"
        n 2c "比起这首，我更喜欢你之前那两首诗。"
        n 1k "我是说......"
        n "你想要尝试不同的东西，我想我不该因此而对你感到生气。"
        n 1c "只要你不是只想博优里欢心什么的。"
        n 5x "有够恶心。"
        mc "好好好。"
        mc "正如你所说，我可以尝试新的东西。"
        label ch3_n_shared:
            show natsuki 5g
            mc "话又说回来，为什么你会对我的诗投入那么多感情？"
            mc "这难道不是对我的一种赞赏吗？"
            n 1o "......诶？"
            n 4x "才、才不是呢！恶心死了！"
            n 4w "我也不是在乎啦！"
